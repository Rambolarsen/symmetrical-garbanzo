    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-slate-800 border border-slate-600 rounded-2xl w-full max-w-4xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-amber-900 px-5 py-4 flex items-center justify-between">
          <div>
            <p className="text-xs text-amber-300 font-medium uppercase tracking-wide">Pre-Planning Review</p>
        ...
        <div className="flex divide-x divide-slate-700" style={{ maxHeight: '65vh' }}>
          ...
          <div className="w-2/5 flex-shrink-0 overflow-y-auto bg-slate-900/60 p-4">
            ...
            {pre.specification
              ? <p className="text-xs text-slate-300 font-mono leading-relaxed whitespace-pre-wrap">{pre.specification}</p>
